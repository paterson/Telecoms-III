...
public abstract class PacketContent {
    ...
    public static final int CONNECTION_PACKET = 100;
    public static final int DATA_PACKET = 200;
    public static final int PING_PACKET = 300;
    int type = 0;
        ...
        try {
            ...
            switch(type) {   // depending on type create content object 
                case CONNECTION_PACKET:
                    content = new ConnectionPacket(oin);
                    break;
                case DATA_PACKET:
                	content = new DataPacket(oin);
                	break;
                case PING_PACKET:
                	content = new Ping(oin);
                	break;
                default:
                    break;
            }
